...
munecas = int(input("Ingrese la cantidad de munecas vendidas: "))
payasos = int(input("Ingrese la cantidad de payasos vendidos: "))
pesototal = (munecas * pesomuneca) + (payasos * pesopayaso)
print("El peso total del paquete a enviar es: ",pesototal,"kg.")
